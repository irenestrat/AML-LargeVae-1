...
vae = VAE(args.use_gpu, args.model_path, args.output_shape, args.latent_length, args.dataset_name, args.number_of_gaussians)
if args.use_gpu:
    vae.cuda()
